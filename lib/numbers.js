  ...
  (function(require, exports, moduleId) {
    ...
    var Section = (function() {
      function Section() {
        ...
        var ctor = function (_properties) {
          var properties = _properties || {};
          this.numbers=Numbers(properties);
          this.element=monads.DOMable({
            tagName:'section'
          }).on('load').attributes({
            'class':'section'
      ...
      Section.init = (function () {
        var styles=[{
          selector:'.section',
          style:"width:210px;height:180px;border:1px solid #CCC;-webkit-perspective:1100px;overflow:hidden;"
        }];
    ...
    var Numbers = (function() {
      ...
      Numbers.prototype['prev'] = function() {
        this.rotation-=this.theta * -1;
        return this.transform();
      };
